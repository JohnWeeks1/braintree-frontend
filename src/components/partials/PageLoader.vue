<template>
    <div>
        <div class="w-full h-full absolute bg-gray-900">
            <svg width="200" height="200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="lds-ripple mt-48 mx-auto" style="background:0 0">
